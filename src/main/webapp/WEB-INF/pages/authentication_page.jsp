    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="form-signin">
                ...
                <button  onclick="check_codice(codice)" class="btn btn-lg btn-primary btn-block" type="submit">Accedi</button>
                <a href="/registrazione"><button class="btn btn-lg btn-primary btn-block">Registrati</button></a>
